    ...
    <>
      ...
      <div className="-mx-4 mb-3 flex gap-2 overflow-x-auto px-4 py-1 no-scrollbar touch-pan-x snap-x snap-mandatory sm:hidden">
        ...
        <div className="flex shrink-0 snap-start items-center gap-2 rounded-lg border border-border bg-card px-2.5 py-1.5 shadow-2xs">
          ...
          <div className="min-w-0">
            <div className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Pending Intake</div>
            <div className="font-mono text-xs font-bold text-foreground">{pendingReceipts} Shipments</div>
          </div>
        </div>
        ...
        <div className="flex shrink-0 snap-start items-center gap-2 rounded-lg border border-border bg-card px-2.5 py-1.5 shadow-2xs">
          ...
          <div className="min-w-0">
            ...
            <div className="font-mono text-xs font-bold text-foreground">{settledCount} Paid POs</div>
          </div>
        </div>
      </div>
