...
import type { ProductImportPreviewState } from "@/server/catalog/types";
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Upload the product template after filling product names, units, tracking modes, prices, and taxes.
            </p>
          </div>
