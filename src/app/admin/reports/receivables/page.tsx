...
import { displayReportMoney, getReceivablesReport, normalizeReportFilters, summarizeMoney } from "@/server/reports/reports";
...
export default async function ReceivablesReportPage({ searchParams }: ReceivablesReportPageProps) {
  ...
  return (
    <PageShell>
      <PageHeader eyebrow="Reports" title="Customer Receivables" />
